          ...
          return(
            <View style={styles.rowLeft}>
              ...
              <View>
                ...
                resizeMode='stretch'
                source={require('./img/message_bubble_left_red_android.png')}
                onLayout={(e) => {
                ...
                style={{justifyContent: 'center', width: viewWidth, height: viewHight, opacity: opacity, paddingHorizontal: 10,}}
                >
                    <View
                      ref={v => this.LeftText = v}
                      style={{ paddingHorizontal: 14 }}
                    >
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'transparent', height: 30, width: window.width / 2, paddingHorizontal: 5 }}>
                        <Text style={{ fontSize: 12, color: '#fff' }}><AWIcon name="clock-o" /> {issueNo}期</Text>
                        <Text style={{ fontSize: 12, color: '#fff' }}>金额:{betAmount}元</Text>
                      </View>
                      <View style={{ height: 30, justifyContent: 'flex-start',  backgroundColor: 'transparent', paddingLeft: 5 }}>
        ...
        return (
          <View style={styles.rowLeft}>
              ...
              <View>
                ...
                capInsets={{top: 30, left: 13, bottom: 18, right: 13}}
                resizeMode='stretch'
                source={require('./img/message_bubble_left_android.png')}
                onLayout={(e) => {
                  this.LeftText.measure((a, b, width, height, px, py) =>{
                    this.setState({
                      viewHight: height,
          ...
          return(
              <View style={styles.rowRight}>
                <Image
                  capInsets={{top: 30, left: 13, bottom: 18, right: 13}}
                  resizeMode='stretch'
                  source={require('./img/message_bubble_right_android.png')}
                  onLayout={(e) => {
                  ...
                  <View
                    ...
                    style={{ maxWidth: window.width * 0.7 }}
                  >
                    <Text
                      numberOfLines={0}
        ...
        return(
          <View style={styles.rowRight}>
                ...
                <Image
                  capInsets={{top: 30, left: 13, bottom: 18, right: 13}}
                  resizeMode='stretch'
                  source={require('./img/message_bubble_right_blue_android.png')}
                  onLayout={(e) => {
                    this.rightText.measure((a, b, width, height, px, py) =>{
                      if (width != viewWidth || height != viewHight) {
                        this.setState({
                  ...
                  >
                    ...
                    >
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'transparent', height: 30, width: window.width / 2, paddingRight: 5 }}>
